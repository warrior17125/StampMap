...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
                    ...
                    device: torch.device, epoch: int, start_time, 
                    total_train_step, writer, max_norm: float = 0):
    model.train()
    criterion.train()
    ...
    for samples in data_loader:
        ...
        if total_train_step % 10 == 0:
            ...
            for i in range(5):
                ...
                writer.add_scalar("frame_{}_point_coord_loss".format(i), loss_dict["frame_{}_point_coord_loss".format(i)].item(), total_train_step)
